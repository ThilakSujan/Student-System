...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
            <strong><i class="bi bi-list-ul me-1"></i>All Fee Structures</strong>
            <div class="d-flex gap-2">
                <button onclick="exportTable('#structTable', 'Fee Structures Report', 'excel')" class="btn btn-success btn-sm" title="Export to Excel">
            <i class="bi bi-file-earmark-excel me-1"></i> Excel
        </button>
                <button onclick="exportTable('#structTable', 'Fee Structures Report', 'pdf')" class="btn btn-danger btn-sm" title="Export to PDF">
