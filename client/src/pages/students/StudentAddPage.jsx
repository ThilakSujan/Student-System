    ...
    <div className="space-y-6 animate-fade-in max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="card">
          ...
          <div className="card-body grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="form-group">
              ...
              <input id="student_name" className={`input ${errors.student_name ? 'input-error' : ''}`} placeholder="e.g. Arjun Kumar" value={form.student_name} onChange={set('student_name')} />
              {errors.student_name && <p className="error-msg">{errors.student_name}</p>}
            </div>

            <div className="form-group">
              <label htmlFor="email" className="label">Email Address *</label>
              <input id="email" type="email" className={`input ${errors.email ? 'input-error' : ''}`} placeholder="student@example.com" value={form.email} onChange={set('email')} />
        ...
        <div className="card">
          ...
          <div className="card-body grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="form-group sm:col-span-2">
              ...
              <input id="skills" className="input" placeholder="Comma-separated, e.g. Python, Music, Cricket" value={form.skills} onChange={set('skills')} />
        ...
        <div className="card">
          ...
          <div className="card-body grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="form-group">
              ...
              <input id="parent_name" className="input" placeholder="e.g. Rajesh Kumar" value={form.parent_name} onChange={set('parent_name')} />
            </div>
            <div className="form-group">
              <label htmlFor="parent_email" className="label">Parent Email</label>
              <input id="parent_email" type="email" className="input" placeholder="parent@example.com" value={form.parent_email} onChange={set('parent_email')} />
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button id="submit-student" type="submit" className="btn btn-primary" disabled={saving}>
            {saving ? (
